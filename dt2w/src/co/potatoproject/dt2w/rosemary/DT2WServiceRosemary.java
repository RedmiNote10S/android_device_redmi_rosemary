...
public class DT2WServiceRosemary extends Service {
    private static final String TAG = "DT2WServiceRosemary";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.rosemary.dt2w", dt2wEnabled ? "1" : "0");
        }
